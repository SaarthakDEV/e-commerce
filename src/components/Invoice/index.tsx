...
import { InvoiceData, InvoiceProps } from "@/libs/types";
  ...
  return (
    <Document>
      <Page size="A4" style={styles?.page}>
        <View
          style={{ display: "flex", marginTop: "2%", flexDirection: "row" }}
        >
          <View style={{ width: "55%" }}>
        ...
        >
          <View style={{ width: "58%", color: "white" }}>
            <Text>Item Description</Text>
          </View>
          <View style={{ width: "12%", color: "white" }}>
            <Text>Qty</Text>
          </View>
          <View style={{ width: "15%", color: "white" }}>
            <Text>Rate</Text>
          </View>
          <View style={{ width: "15%", color: "white" }}>
            <Text>Amount</Text>
        ...
        >
          ...
          <View style={{ width: "55%" }}>
            ...
            >
              <Text>Sales Tax(10%)</Text>
              <Text>{(data?.totalAmount! * 0.1).toFixed(2)}</Text>
            </View>
            <View
              style={{
                display: "flex",
            ...
            >
              <Text>Total</Text>
              <Text>{data?.totalAmount! + data?.totalAmount! * 0.1}</Text>
            </View>
          </View>
        </View>
        <View>
          ...
          <Text style={{ fontSize: "5px" }}>
            This invoice is computer generated and hence doesn't require any
            signature
          </Text>
        </View>
        <View style={{ marginTop: "5%" }}>
          <Text>
            ------------------------------------This marks the end of your
            invoice------------------------------------
          </Text>
        </View>
      </Page>
