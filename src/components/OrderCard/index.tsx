    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-100">
              ...
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <div className="text-lg font-semibold text-gray-900">...{order.id.substring(15)}</div>
                </div>
                <div className="flex gap-4 text-right">
                  <div className="text-sm text-gray-500 mb-1">Arrival {order.date}</div>
                  <span className={`capitalize inline-flex px-2 font-medium rounded-full ${getStatusColor(order.status)}`}>
                    {order.status}
                  </span>
                </div>
              </div>
              ...
              {/* Product Info */}
                <div className="flex items-center space-x-3 mb-4">
                  <div className="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center">
                    <img src={order.productImage} alt={order.productName} className="w-16 h-16 text-gray-400" />
                  </div>
