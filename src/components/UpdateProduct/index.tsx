...
const UpdateProduct:React.FC<UpdateProductProps> = ({product}) => {
  ...
  const validateForm = () => {
    ...
    setErrors(newErrors);
    return Object.keys(newErrors).every(error => newErrors[error].length === 0);
  };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            {/* Product Name */}
            <div className="mb-6">
              <label htmlFor="name" className="flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            {/* Description */}
            <div className="mb-6">
              <label htmlFor="description" className="flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="mb-6">
              ...
              />
                ...
                { formData.image && <div className="relative inline-block mt-2">
                  <img
                    src={formData.image}
                    alt="Product preview"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <label htmlFor="price" className="flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input
                  ...
                  min="0"
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 ${
                    errors.price ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600'
                  }`}
                />
                {errors.price && (
                  <p className="mt-1 text-sm text-red-600 dark:text-red-400 flex items-center space-x-1">
              ...
              <div>
                <label htmlFor="stock" className="flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input
                  ...
                  min="0"
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 ${
                    errors.stock ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600'
                  }`}
                />
                {errors.stock && (
                  <p className="mt-1 text-sm text-red-600 dark:text-red-400 flex items-center space-x-1">
